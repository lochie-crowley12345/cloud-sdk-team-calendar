...
exports.WorkScheduleDayModelAssignmentApi = void 0;
/*
...
const WorkScheduleDayModelAssignmentRequestBuilder_1 = require("./WorkScheduleDayModelAssignmentRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class WorkScheduleDayModelAssignmentApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = WorkScheduleDayModelAssignment_1.WorkScheduleDayModelAssignment;
        this.deSerializers = deSerializers;
    }
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            DAY_MODEL_NAV: new odata_v2_1.OneToOneLink('dayModelNav', this, linkedApis[0]),
            SEGMENTS: new odata_v2_1.Link('segments', this, linkedApis[1])
        };
        return this;
    }
    requestBuilder() {
        return new WorkScheduleDayModelAssignmentRequestBuilder_1.WorkScheduleDayModelAssignmentRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(WorkScheduleDayModelAssignment_1.WorkScheduleDayModelAssignment, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', WorkScheduleDayModelAssignment_1.WorkScheduleDayModelAssignment)
            };
        }
        return this._schema;
    }
}
exports.WorkScheduleDayModelAssignmentApi = WorkScheduleDayModelAssignmentApi;
//# sourceMappingURL=WorkScheduleDayModelAssignmentApi.js.map