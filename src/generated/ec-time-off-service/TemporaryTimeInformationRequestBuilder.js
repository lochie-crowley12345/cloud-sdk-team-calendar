 ...
 */
class TemporaryTimeInformationRequestBuilder extends odata_v2_1.RequestBuilder {
    /**
    ...
    delete(externalCodeOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, externalCodeOrEntity instanceof TemporaryTimeInformation_1.TemporaryTimeInformation
