...
export class TimeAccountDetailApi<
...
> implements EntityApi<TimeAccountDetail<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TimeAccountDetail<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    TIME_ACCOUNT_EXTERNAL_CODE: OrderableEdmTypeField<
      TimeAccountDetail<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_ACCOUNT_EXTERNAL_CODE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_PERIOD_ID: fieldBuilder.buildEdmTypeField(
          'accrualPeriodId',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ADVANCED: fieldBuilder.buildEdmTypeField(
          'advanced',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_AMOUNT: fieldBuilder.buildEdmTypeField(
          'bookingAmount',
          'Edm.Decimal',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_DATE: fieldBuilder.buildEdmTypeField(
          'bookingDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_TYPE: fieldBuilder.buildEdmTypeField(
          'bookingType',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_UNIT: fieldBuilder.buildEdmTypeField(
          'bookingUnit',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CALENDAR_ENTRY: fieldBuilder.buildEdmTypeField(
          'calendarEntry',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CHANGE_CALENDAR: fieldBuilder.buildEdmTypeField(
          'changeCalendar',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PAYOUT_ACCRUAL_SEPARATED: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PERIODIC_UPDATE_PERIOD_ID: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        REFERENCE_OBJECT: fieldBuilder.buildEdmTypeField(
          'referenceObject',
          'Edm.String',
          true
        ),
