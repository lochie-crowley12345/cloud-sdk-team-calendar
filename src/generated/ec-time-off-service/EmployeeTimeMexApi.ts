...
export class EmployeeTimeMexApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<EmployeeTimeMex<DeSerializersT>, DeSerializersT>
{
  ...
  requestBuilder(): EmployeeTimeMexRequestBuilder<DeSerializersT> {
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimeMex<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<EmployeeTimeMex<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    ...
    CREATED_DATE_TIME: OrderableEdmTypeField<
      ...
      true
    >;
    CUST_MEX: OrderableEdmTypeField<
      EmployeeTimeMex<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    CUST_TEST: OrderableEdmTypeField<
      ...
      true
    >;
    DAYS_ALREADY_CUMULATED_FOR_SAME_SICKNESS: OrderableEdmTypeField<
      EmployeeTimeMex<DeSerializers>,
      DeSerializersT,
      'Edm.Decimal',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_MEX: fieldBuilder.buildEdmTypeField(
          'cust_MEX',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DAYS_ALREADY_CUMULATED_FOR_SAME_SICKNESS:
