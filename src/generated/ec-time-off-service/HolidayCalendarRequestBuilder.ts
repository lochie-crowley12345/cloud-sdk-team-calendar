 ...
 */
export class HolidayCalendarRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<HolidayCalendar<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<HolidayCalendar<T>, T> {
    return new GetByKeyRequestBuilder<HolidayCalendar<T>, T>(this.entityApi, {
