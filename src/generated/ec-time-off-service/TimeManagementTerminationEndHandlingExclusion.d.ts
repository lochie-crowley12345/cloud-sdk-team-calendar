 ...
 */
export declare class TimeManagementTerminationEndHandlingExclusion<
  ...
  implements TimeManagementTerminationEndHandlingExclusionType<T>
{
  ...
  constructor(_entityApi: TimeManagementTerminationEndHandlingExclusionApi<T>);
}
...
//# sourceMappingURL=TimeManagementTerminationEndHandlingExclusion.d.ts.map
