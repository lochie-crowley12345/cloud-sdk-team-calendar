...
export class EmployeeTimeGroupItemApi<
...
> implements EntityApi<EmployeeTimeGroupItem<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    linkedApis: [EmployeeTimeApi<DeSerializersT>]
  ): this {
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimeGroupItem<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    EMPLOYEE_TIME_GROUP_EXTERNAL_CODE: OrderableEdmTypeField<
      EmployeeTimeGroupItem<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        EMPLOYEE_TIME_GROUP_EXTERNAL_CODE: fieldBuilder.buildEdmTypeField(
          'EmployeeTimeGroup_externalCode',
          'Edm.String',
          false
        ),
        /**
