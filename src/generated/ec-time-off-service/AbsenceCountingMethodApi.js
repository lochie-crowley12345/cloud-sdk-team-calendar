...
exports.AbsenceCountingMethodApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const AbsenceCountingMethod_1 = require("./AbsenceCountingMethod");
const AbsenceCountingMethodRequestBuilder_1 = require("./AbsenceCountingMethodRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class AbsenceCountingMethodApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = AbsenceCountingMethod_1.AbsenceCountingMethod;
    ...
    requestBuilder() {
        return new AbsenceCountingMethodRequestBuilder_1.AbsenceCountingMethodRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(AbsenceCountingMethod_1.AbsenceCountingMethod, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                ...
                /**
                 * Static representation of the {@link deductionFactor} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DEDUCTION_FACTOR: fieldBuilder.buildEdmTypeField('deductionFactor', 'Edm.Decimal', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', AbsenceCountingMethod_1.AbsenceCountingMethod)
            };
        }
        return this._schema;
    }
}
exports.AbsenceCountingMethodApi = AbsenceCountingMethodApi;
//# sourceMappingURL=AbsenceCountingMethodApi.js.map