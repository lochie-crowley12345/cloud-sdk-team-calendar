 ...
 */
export declare class TimeTypeUsa<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements TimeTypeUsaType<T>
{
  readonly _entityApi: TimeTypeUsaApi<T>;
  /**
  ...
  constructor(_entityApi: TimeTypeUsaApi<T>);
}
