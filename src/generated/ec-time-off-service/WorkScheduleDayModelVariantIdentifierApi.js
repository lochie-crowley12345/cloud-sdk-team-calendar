...
exports.WorkScheduleDayModelVariantIdentifierApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const WorkScheduleDayModelVariantIdentifier_1 = require("./WorkScheduleDayModelVariantIdentifier");
const WorkScheduleDayModelVariantIdentifierRequestBuilder_1 = require("./WorkScheduleDayModelVariantIdentifierRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class WorkScheduleDayModelVariantIdentifierApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = WorkScheduleDayModelVariantIdentifier_1.WorkScheduleDayModelVariantIdentifier;
    ...
    requestBuilder() {
        return new WorkScheduleDayModelVariantIdentifierRequestBuilder_1.WorkScheduleDayModelVariantIdentifierRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(WorkScheduleDayModelVariantIdentifier_1.WorkScheduleDayModelVariantIdentifier, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', WorkScheduleDayModelVariantIdentifier_1.WorkScheduleDayModelVariantIdentifier)
            };
        }
        return this._schema;
    }
}
exports.WorkScheduleDayModelVariantIdentifierApi = WorkScheduleDayModelVariantIdentifierApi;
//# sourceMappingURL=WorkScheduleDayModelVariantIdentifierApi.js.map