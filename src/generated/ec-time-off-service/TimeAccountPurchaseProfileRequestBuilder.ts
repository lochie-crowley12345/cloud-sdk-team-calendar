 ...
 */
export class TimeAccountPurchaseProfileRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TimeAccountPurchaseProfile<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TimeAccountPurchaseProfile<T>, T> {
    return new GetByKeyRequestBuilder<TimeAccountPurchaseProfile<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<TimeAccountPurchaseProfile<T>, T> {
    return new GetAllRequestBuilder<TimeAccountPurchaseProfile<T>, T>(
      this.entityApi
    );
  }
}
