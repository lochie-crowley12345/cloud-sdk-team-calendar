 ...
 */
export class EmployeeTimeGroupRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<EmployeeTimeGroup<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<EmployeeTimeGroup<T>, T> {
    return new GetByKeyRequestBuilder<EmployeeTimeGroup<T>, T>(this.entityApi, {
