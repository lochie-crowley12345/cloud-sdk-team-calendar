...
exports.AccrualCalculationBaseApi = void 0;
/*
...
const AccrualCalculationBaseRequestBuilder_1 = require("./AccrualCalculationBaseRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class AccrualCalculationBaseApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = AccrualCalculationBase_1.AccrualCalculationBase;
    ...
    requestBuilder() {
        return new AccrualCalculationBaseRequestBuilder_1.AccrualCalculationBaseRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(AccrualCalculationBase_1.AccrualCalculationBase, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', AccrualCalculationBase_1.AccrualCalculationBase)
            };
        }
        return this._schema;
    }
}
exports.AccrualCalculationBaseApi = AccrualCalculationBaseApi;
//# sourceMappingURL=AccrualCalculationBaseApi.js.map