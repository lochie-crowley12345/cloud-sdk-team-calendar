...
exports.ElectronicSicknessCertificateExclusionReasonDeuApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const ElectronicSicknessCertificateExclusionReasonDeu_1 = require("./ElectronicSicknessCertificateExclusionReasonDeu");
const ElectronicSicknessCertificateExclusionReasonDeuRequestBuilder_1 = require("./ElectronicSicknessCertificateExclusionReasonDeuRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class ElectronicSicknessCertificateExclusionReasonDeuApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = ElectronicSicknessCertificateExclusionReasonDeu_1.ElectronicSicknessCertificateExclusionReasonDeu;
    ...
    requestBuilder() {
        return new ElectronicSicknessCertificateExclusionReasonDeuRequestBuilder_1.ElectronicSicknessCertificateExclusionReasonDeuRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(ElectronicSicknessCertificateExclusionReasonDeu_1.ElectronicSicknessCertificateExclusionReasonDeu, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', ElectronicSicknessCertificateExclusionReasonDeu_1.ElectronicSicknessCertificateExclusionReasonDeu)
            };
        }
        return this._schema;
    }
}
exports.ElectronicSicknessCertificateExclusionReasonDeuApi = ElectronicSicknessCertificateExclusionReasonDeuApi;
//# sourceMappingURL=ElectronicSicknessCertificateExclusionReasonDeuApi.js.map