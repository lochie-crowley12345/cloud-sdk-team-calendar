...
export class ShiftClassificationApi<
...
> implements EntityApi<ShiftClassification<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ShiftClassification<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    COUNTRY: OrderableEdmTypeField<
      ShiftClassification<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
