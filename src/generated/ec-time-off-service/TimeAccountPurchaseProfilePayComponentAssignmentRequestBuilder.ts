 ...
 */
export class TimeAccountPurchaseProfilePayComponentAssignmentRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<
  TimeAccountPurchaseProfilePayComponentAssignment<T>,
  T
> {
  /**
  ...
  > {
    ...
    >(this.entityApi, {
      TimeAccountPurchaseProfile_externalCode:
        timeAccountPurchaseProfileExternalCode,
