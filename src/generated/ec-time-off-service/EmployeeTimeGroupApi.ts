...
export class EmployeeTimeGroupApi<
...
> implements EntityApi<EmployeeTimeGroup<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ITEMS: new Link('items', this, linkedApis[0])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimeGroup<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    CREATED_BY: OrderableEdmTypeField<
      EmployeeTimeGroup<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ITEMS_CATEGORY: fieldBuilder.buildEdmTypeField(
          'itemsCategory',
          'Edm.String',
          true
        ),
