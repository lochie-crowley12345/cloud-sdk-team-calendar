 ...
 */
export declare class PeriodicTimeAccountUpdateProfile<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PeriodicTimeAccountUpdateProfileType<T>
{
  readonly _entityApi: PeriodicTimeAccountUpdateProfileApi<T>;
  /**
  ...
  constructor(_entityApi: PeriodicTimeAccountUpdateProfileApi<T>);
}
...
//# sourceMappingURL=PeriodicTimeAccountUpdateProfile.d.ts.map
