 ...
 */
export class TimeTypeRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TimeType<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TimeType<T>, T> {
    return new GetByKeyRequestBuilder<TimeType<T>, T>(this.entityApi, {
