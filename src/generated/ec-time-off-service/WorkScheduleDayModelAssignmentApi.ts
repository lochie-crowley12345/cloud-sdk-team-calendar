...
export class WorkScheduleDayModelAssignmentApi<
    ...
    EntityApi<WorkScheduleDayModelAssignment<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      DAY_MODEL_NAV: new OneToOneLink('dayModelNav', this, linkedApis[0]),
      SEGMENTS: new Link('segments', this, linkedApis[1])
    };
    return this;
  }
  ...
  requestBuilder(): WorkScheduleDayModelAssignmentRequestBuilder<DeSerializersT> {
    return new WorkScheduleDayModelAssignmentRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    WORK_SCHEDULE_EXTERNAL_CODE: OrderableEdmTypeField<
      WorkScheduleDayModelAssignment<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WORK_SCHEDULE_EXTERNAL_CODE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DAY_MODEL: fieldBuilder.buildEdmTypeField(
          'dayModel',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DAY_WORKING_HOURS: fieldBuilder.buildEdmTypeField(
          'dayWorkingHours',
          'Edm.Decimal',
          true
        ),
