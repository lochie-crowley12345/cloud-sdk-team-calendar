...
exports.ShiftClassificationApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const ShiftClassification_1 = require("./ShiftClassification");
const ShiftClassificationRequestBuilder_1 = require("./ShiftClassificationRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class ShiftClassificationApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = ShiftClassification_1.ShiftClassification;
    ...
    requestBuilder() {
        return new ShiftClassificationRequestBuilder_1.ShiftClassificationRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(ShiftClassification_1.ShiftClassification, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', ShiftClassification_1.ShiftClassification)
            };
        }
        return this._schema;
    }
}
exports.ShiftClassificationApi = ShiftClassificationApi;
//# sourceMappingURL=ShiftClassificationApi.js.map