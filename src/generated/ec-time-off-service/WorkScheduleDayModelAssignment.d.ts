 ...
 */
export declare class WorkScheduleDayModelAssignment<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements WorkScheduleDayModelAssignmentType<T>
{
  readonly _entityApi: WorkScheduleDayModelAssignmentApi<T>;
  /**
  ...
  constructor(_entityApi: WorkScheduleDayModelAssignmentApi<T>);
}
