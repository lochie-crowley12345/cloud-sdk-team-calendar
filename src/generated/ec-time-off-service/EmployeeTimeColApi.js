...
exports.EmployeeTimeColApi = void 0;
/*
...
const EmployeeTimeColRequestBuilder_1 = require("./EmployeeTimeColRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class EmployeeTimeColApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = EmployeeTimeCol_1.EmployeeTimeCol;
    ...
    requestBuilder() {
        return new EmployeeTimeColRequestBuilder_1.EmployeeTimeColRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(EmployeeTimeCol_1.EmployeeTimeCol, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', EmployeeTimeCol_1.EmployeeTimeCol)
            };
        }
        return this._schema;
    }
}
exports.EmployeeTimeColApi = EmployeeTimeColApi;
//# sourceMappingURL=EmployeeTimeColApi.js.map