...
export class EmpTimeAccountBalanceApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<EmpTimeAccountBalance<DeSerializersT>, DeSerializersT>
{
  ...
  requestBuilder(): EmpTimeAccountBalanceRequestBuilder<DeSerializersT> {
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmpTimeAccountBalance<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    ACCOUNT_CLOSED: OrderableEdmTypeField<
      EmpTimeAccountBalance<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
      true
    ...
    TIME_ACCOUNT_TYPE: OrderableEdmTypeField<
      ...
      true
    >;
    TIME_UNIT: OrderableEdmTypeField<
      EmpTimeAccountBalance<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_UNIT: fieldBuilder.buildEdmTypeField(
          'timeUnit',
          'Edm.String',
          true
        ),
