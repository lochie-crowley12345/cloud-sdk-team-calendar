 ...
 */
export class EmployeeTimeEspRequestBuilder<
...
> extends RequestBuilder<EmployeeTimeEsp<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<EmployeeTimeEsp<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<EmployeeTimeEsp<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<EmployeeTimeEsp<T>, T>(
      this.entityApi,
      employeeTimeExternalCodeOrEntity instanceof EmployeeTimeEsp
