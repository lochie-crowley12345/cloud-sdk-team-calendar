 ...
 */
export declare class HolidayCategory<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements HolidayCategoryType<T>
{
  readonly _entityApi: HolidayCategoryApi<T>;
  /**
  ...
  constructor(_entityApi: HolidayCategoryApi<T>);
}
...
//# sourceMappingURL=HolidayCategory.d.ts.map
