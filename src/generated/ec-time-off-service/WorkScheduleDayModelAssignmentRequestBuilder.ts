 ...
 */
export class WorkScheduleDayModelAssignmentRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
    return new GetByKeyRequestBuilder<WorkScheduleDayModelAssignment<T>, T>(
      this.entityApi,
      {
  ...
  getAll(): GetAllRequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
    return new GetAllRequestBuilder<WorkScheduleDayModelAssignment<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: WorkScheduleDayModelAssignment<T>
  ): CreateRequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
    return new CreateRequestBuilder<WorkScheduleDayModelAssignment<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    entity: WorkScheduleDayModelAssignment<T>
  ): UpdateRequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
    return new UpdateRequestBuilder<WorkScheduleDayModelAssignment<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    day: BigNumber
  ): DeleteRequestBuilder<WorkScheduleDayModelAssignment<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `WorkScheduleDayModelAssignment`.
  ...
  delete(
    workScheduleExternalCodeOrEntity: any,
    day?: BigNumber
  ): DeleteRequestBuilder<WorkScheduleDayModelAssignment<T>, T> {
    return new DeleteRequestBuilder<WorkScheduleDayModelAssignment<T>, T>(
      this.entityApi,
      workScheduleExternalCodeOrEntity instanceof WorkScheduleDayModelAssignment
