 ...
 */
export declare class TimeAccount<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements TimeAccountType<T>
{
  readonly _entityApi: TimeAccountApi<T>;
  /**
  ...
  constructor(_entityApi: TimeAccountApi<T>);
}
