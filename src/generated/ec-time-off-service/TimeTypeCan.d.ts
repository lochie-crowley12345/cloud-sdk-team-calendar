...
import type { TimeTypeCanApi } from './TimeTypeCanApi';
/**
 * This class represents the entity "TimeTypeCAN" of service "ECTimeOff".
 */
export declare class TimeTypeCan<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements TimeTypeCanType<T>
{
  readonly _entityApi: TimeTypeCanApi<T>;
  /**
  ...
  constructor(_entityApi: TimeTypeCanApi<T>);
}
