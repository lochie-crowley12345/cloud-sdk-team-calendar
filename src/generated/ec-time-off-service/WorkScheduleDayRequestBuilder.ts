 ...
 */
export class WorkScheduleDayRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<WorkScheduleDay<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<WorkScheduleDay<T>, T> {
   ...
   */
  create(
    entity: WorkScheduleDay<T>
  ): CreateRequestBuilder<WorkScheduleDay<T>, T> {
    return new CreateRequestBuilder<WorkScheduleDay<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    entity: WorkScheduleDay<T>
  ): UpdateRequestBuilder<WorkScheduleDay<T>, T> {
    return new UpdateRequestBuilder<WorkScheduleDay<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    day: BigNumber
  ): DeleteRequestBuilder<WorkScheduleDay<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `WorkScheduleDay`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<WorkScheduleDay<T>, T>(
      this.entityApi,
      workScheduleExternalCodeOrEntity instanceof WorkScheduleDay
