...
> implements EntityApi<HolidayCalendar<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      HOLIDAY_ASSIGNMENTS: new Link('holidayAssignments', this, linkedApis[0])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<HolidayCalendar<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_AR_SA: fieldBuilder.buildEdmTypeField(
          'name_ar_SA',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_CY_GB: fieldBuilder.buildEdmTypeField(
          'name_cy_GB',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_EN_DEBUG: fieldBuilder.buildEdmTypeField(
          'name_en_DEBUG',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_EN_DEBUG_APOS: fieldBuilder.buildEdmTypeField(
          'name_en_DEBUG_APOS',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_EN_DEBUG_APOS_RTL: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_EN_RTL: fieldBuilder.buildEdmTypeField(
          'name_en_RTL',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_ES_MX: fieldBuilder.buildEdmTypeField(
          'name_es_MX',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_FR_CA: fieldBuilder.buildEdmTypeField(
          'name_fr_CA',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_HI_IN: fieldBuilder.buildEdmTypeField(
          'name_hi_IN',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_IW_IL: fieldBuilder.buildEdmTypeField(
          'name_iw_IL',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        NAME_TH_TH: fieldBuilder.buildEdmTypeField(
          'name_th_TH',
          'Edm.String',
          true
        ),
