 ...
 */
export declare class TimeTypeDeu<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements TimeTypeDeuType<T>
{
  readonly _entityApi: TimeTypeDeuApi<T>;
  /**
  ...
  constructor(_entityApi: TimeTypeDeuApi<T>);
}
...
//# sourceMappingURL=TimeTypeDeu.d.ts.map
