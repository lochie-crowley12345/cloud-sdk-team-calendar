...
export class WorkScheduleDayModelAssignmentSegmentApi<
    ...
    >
{
  ...
  requestBuilder(): WorkScheduleDayModelAssignmentSegmentRequestBuilder<DeSerializersT> {
    return new WorkScheduleDayModelAssignmentSegmentRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    WORK_SCHEDULE_DAY_MODEL_ASSIGNMENT_DAY: OrderableEdmTypeField<
      WorkScheduleDayModelAssignmentSegment<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         */
        WORK_SCHEDULE_DAY_MODEL_ASSIGNMENT_DAY: fieldBuilder.buildEdmTypeField(
