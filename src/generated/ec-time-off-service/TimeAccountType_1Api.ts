...
export class TimeAccountType_1Api<
...
> implements EntityApi<TimeAccountType_1<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      PERIODIC_TIME_ACCOUNT_UPDATE_PROFILE_NAV: new OneToOneLink(
        'periodicTimeAccountUpdateProfileNav',
        this,
        linkedApis[1]
      ),
      RECALCULATION_BASED_FIELD_LIST: new Link(
        'recalculationBasedFieldList',
        this,
        linkedApis[2]
      ),
      TIME_ACCOUNT_PAYOUT_PROFILE_NAV: new OneToOneLink(
        'timeAccountPayoutProfileNav',
        this,
        linkedApis[3]
      ),
      TIME_ACCOUNT_PURCHASE_PROFILE_NAV: new OneToOneLink(
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TimeAccountType_1<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    ACCOUNT_BOOKING_OFFSET_IN_MONTHS: OrderableEdmTypeField<
      TimeAccountType_1<DeSerializers>,
      DeSerializersT,
      'Edm.Int64',
      true,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_BOOKING_OFFSET_IN_MONTHS: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CREATION_AUTOMATION_LEVEL: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CREATION_DAY: fieldBuilder.buildEdmTypeField(
          'accountCreationDay',
          'Edm.Int64',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CREATION_MONTH: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CREATION_OFFSET_IN_MONTHS: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CREATION_REFERENCE_DATE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_DETAIL_RETENTION_GROUP: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_RETENTION_GROUP: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_AUTOMATION_LEVEL: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_CALCULATION_METHOD: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_CREATION_OFFSET: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_FREQUENCY: fieldBuilder.buildEdmTypeField(
          'accrualFrequency',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_FREQUENCY_START_DATE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_PERIOD_START_DAY: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_PERIOD_START_MONTH: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_RECALCULATION_POSTING_METHOD: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_RULE: fieldBuilder.buildEdmTypeField(
          'accrualRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_TRANSFER_DATE_RULE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_TRANSFER_RULE: fieldBuilder.buildEdmTypeField(
          'accrualTransferRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_WAITING_PERIOD: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCRUAL_WAITING_PERIOD_UNIT: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ADVANCES_ALLOWED: fieldBuilder.buildEdmTypeField(
          'advancesAllowed',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ALLOW_PAYOUT_WITH_SIMULATION: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CALCULATE_SNAPSHOT_APPROVED_ABSENCE_BALANCE:
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CREATION: fieldBuilder.buildEdmTypeField(
          'creation',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        EFFECT_ON_TRANSFER_DATE_RULE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENTITLEMENT_METHOD: fieldBuilder.buildEdmTypeField(
          'entitlementMethod',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        HIRE_RULE: fieldBuilder.buildEdmTypeField(
          'hireRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INITIAL_ACCRUAL_TRANSFER_DATE_RULE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INITIAL_FLEXIBLE_ACCOUNT_START_DATE_RULE:
          fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INTERIM_RULE: fieldBuilder.buildEdmTypeField(
          'interimRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        LEVEL_OF_SIMULATION_PRECISION: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        MAXIMUM_SIMULATION_HORIZON_IN_MONTHS: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        MINIMUM_BALANCE_ALLOWED: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PAYOUT_ELIGIBILITY: fieldBuilder.buildEdmTypeField(
          'payoutEligibility',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PEP_CALENDAR_AUTOMATION_LEVEL: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PERIOD_END_PROCESSING_RULE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PERIODIC_TIME_ACCOUNT_UPDATE_PROFILE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PURCHASE_ELIGIBILITY: fieldBuilder.buildEdmTypeField(
          'purchaseEligibility',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SECOND_ACCRUAL_CREATION_OFFSET: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SIMULATE_ACCRUALS: fieldBuilder.buildEdmTypeField(
          'simulateAccruals',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SIMULATION_RULE: fieldBuilder.buildEdmTypeField(
          'simulationRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SNAPSHOTS_ALLOWED: fieldBuilder.buildEdmTypeField(
          'snapshotsAllowed',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TERMINATION_RULE: fieldBuilder.buildEdmTypeField(
          'terminationRule',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TERMINATION_RULE_DATA_EFFECTIVE_DATE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_ACCOUNT_CONFIGURATION_RULE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_ACCOUNT_PAYOUT_PROFILE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_ACCOUNT_PURCHASE_PROFILE: fieldBuilder.buildEdmTypeField(
