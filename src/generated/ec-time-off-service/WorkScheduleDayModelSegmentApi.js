...
exports.WorkScheduleDayModelSegmentApi = void 0;
/*
...
const WorkScheduleDayModelSegmentRequestBuilder_1 = require("./WorkScheduleDayModelSegmentRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class WorkScheduleDayModelSegmentApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = WorkScheduleDayModelSegment_1.WorkScheduleDayModelSegment;
    ...
    requestBuilder() {
        return new WorkScheduleDayModelSegmentRequestBuilder_1.WorkScheduleDayModelSegmentRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(WorkScheduleDayModelSegment_1.WorkScheduleDayModelSegment, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', WorkScheduleDayModelSegment_1.WorkScheduleDayModelSegment)
            };
        }
        return this._schema;
    }
}
exports.WorkScheduleDayModelSegmentApi = WorkScheduleDayModelSegmentApi;
//# sourceMappingURL=WorkScheduleDayModelSegmentApi.js.map