 ...
 */
export class ShiftClassificationRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<ShiftClassification<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<ShiftClassification<T>, T> {
    return new GetByKeyRequestBuilder<ShiftClassification<T>, T>(
      this.entityApi,
