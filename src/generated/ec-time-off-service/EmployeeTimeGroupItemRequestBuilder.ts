 ...
 */
export class EmployeeTimeGroupItemRequestBuilder<
...
> extends RequestBuilder<EmployeeTimeGroupItem<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EmployeeTimeGroupItem<T>, T>(
      this.entityApi,
      {
  ...
  getAll(): GetAllRequestBuilder<EmployeeTimeGroupItem<T>, T> {
    return new GetAllRequestBuilder<EmployeeTimeGroupItem<T>, T>(
      this.entityApi
    );
  }
}
