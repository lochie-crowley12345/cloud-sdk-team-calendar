...
export class TemporaryTimeInformationApi<
    ...
    EntityApi<TemporaryTimeInformation<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    COMMENT: OrderableEdmTypeField<
      TemporaryTimeInformation<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_TRGHTRY: fieldBuilder.buildEdmTypeField(
          'cust_trghtry',
          'Edm.Int64',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_TRHTRH: fieldBuilder.buildEdmTypeField(
          'cust_trhtrh',
          'Edm.DateTimeOffset',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WORK_SCHEDULE: fieldBuilder.buildEdmTypeField(
          'workSchedule',
          'Edm.String',
          true
        ),
