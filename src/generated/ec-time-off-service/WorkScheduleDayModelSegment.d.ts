...
import type { WorkScheduleDayModelSegmentApi } from './WorkScheduleDayModelSegmentApi';
/**
 * This class represents the entity "WorkScheduleDayModelSegment" of service "ECTimeOff".
 */
export declare class WorkScheduleDayModelSegment<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements WorkScheduleDayModelSegmentType<T>
{
  readonly _entityApi: WorkScheduleDayModelSegmentApi<T>;
  /**
  ...
  constructor(_entityApi: WorkScheduleDayModelSegmentApi<T>);
}
