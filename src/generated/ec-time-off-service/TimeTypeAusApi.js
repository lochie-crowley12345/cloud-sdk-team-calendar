...
exports.TimeTypeAusApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const TimeTypeAus_1 = require("./TimeTypeAus");
const TimeTypeAusRequestBuilder_1 = require("./TimeTypeAusRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class TimeTypeAusApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = TimeTypeAus_1.TimeTypeAus;
    ...
    requestBuilder() {
        return new TimeTypeAusRequestBuilder_1.TimeTypeAusRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TimeTypeAus_1.TimeTypeAus, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TimeTypeAus_1.TimeTypeAus)
            };
        }
        return this._schema;
    }
}
exports.TimeTypeAusApi = TimeTypeAusApi;
//# sourceMappingURL=TimeTypeAusApi.js.map