 ...
 */
export class EmployeeTimeRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<EmployeeTime<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<EmployeeTime<T>, T> {
    return new GetByKeyRequestBuilder<EmployeeTime<T>, T>(this.entityApi, {
  ...
  delete(externalCodeOrEntity: any): DeleteRequestBuilder<EmployeeTime<T>, T> {
    return new DeleteRequestBuilder<EmployeeTime<T>, T>(
      this.entityApi,
      externalCodeOrEntity instanceof EmployeeTime
