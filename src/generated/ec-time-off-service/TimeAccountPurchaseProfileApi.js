...
exports.TimeAccountPurchaseProfileApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const TimeAccountPurchaseProfile_1 = require("./TimeAccountPurchaseProfile");
const TimeAccountPurchaseProfileRequestBuilder_1 = require("./TimeAccountPurchaseProfileRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class TimeAccountPurchaseProfileApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = TimeAccountPurchaseProfile_1.TimeAccountPurchaseProfile;
        this.deSerializers = deSerializers;
    }
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            DEDUCTION_PAY_COMPONENTS: new odata_v2_1.Link('deductionPayComponents', this, linkedApis[0])
        };
        return this;
    }
    requestBuilder() {
        return new TimeAccountPurchaseProfileRequestBuilder_1.TimeAccountPurchaseProfileRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TimeAccountPurchaseProfile_1.TimeAccountPurchaseProfile, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_AR_SA: fieldBuilder.buildEdmTypeField('helpText_ar_SA', 'Edm.String', true),
                /**
                 * Static representation of the {@link helpTextCyGb} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_CY_GB: fieldBuilder.buildEdmTypeField('helpText_cy_GB', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_EN_DEBUG_APOS: fieldBuilder.buildEdmTypeField('helpText_en_DEBUG_APOS', 'Edm.String', true),
                /**
                 * Static representation of the {@link helpTextEnDebugAposRtl} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_EN_DEBUG_APOS_RTL: fieldBuilder.buildEdmTypeField('helpText_en_DEBUG_APOS_RTL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_EN_RTL: fieldBuilder.buildEdmTypeField('helpText_en_RTL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_ES_MX: fieldBuilder.buildEdmTypeField('helpText_es_MX', 'Edm.String', true),
                /**
                 * Static representation of the {@link helpTextFrCa} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_FR_CA: fieldBuilder.buildEdmTypeField('helpText_fr_CA', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_HI_IN: fieldBuilder.buildEdmTypeField('helpText_hi_IN', 'Edm.String', true),
                /**
                 * Static representation of the {@link helpTextIwIl} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_IW_IL: fieldBuilder.buildEdmTypeField('helpText_iw_IL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                HELP_TEXT_TH_TH: fieldBuilder.buildEdmTypeField('helpText_th_TH', 'Edm.String', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TimeAccountPurchaseProfile_1.TimeAccountPurchaseProfile)
            };
        }
        return this._schema;
    }
}
exports.TimeAccountPurchaseProfileApi = TimeAccountPurchaseProfileApi;
//# sourceMappingURL=TimeAccountPurchaseProfileApi.js.map