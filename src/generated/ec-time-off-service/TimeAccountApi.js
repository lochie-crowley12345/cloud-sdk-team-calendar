...
const TimeAccountRequestBuilder_1 = require("./TimeAccountRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class TimeAccountApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = TimeAccount_1.TimeAccount;
        this.deSerializers = deSerializers;
    }
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ACCOUNT_TYPE_NAV: new odata_v2_1.OneToOneLink('accountTypeNav', this, linkedApis[0]),
            TIME_ACCOUNT_DETAILS: new odata_v2_1.Link('timeAccountDetails', this, linkedApis[1])
        };
        return this;
    }
    requestBuilder() {
        return new TimeAccountRequestBuilder_1.TimeAccountRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TimeAccount_1.TimeAccount, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUST_CUST_DENMARK_VALUE: fieldBuilder.buildEdmTypeField('cust_Cust_Denmark_value', 'Edm.Decimal', true),
                /**
                 * Static representation of the {@link custTest} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUST_TEST: fieldBuilder.buildEdmTypeField('cust_test', 'Edm.Decimal', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TimeAccount_1.TimeAccount)
            };
        }
        return this._schema;
    }
}
exports.TimeAccountApi = TimeAccountApi;
//# sourceMappingURL=TimeAccountApi.js.map