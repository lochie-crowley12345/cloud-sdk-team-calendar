...
exports.WorkScheduleDayModelApi = void 0;
/*
...
const WorkScheduleDayModelRequestBuilder_1 = require("./WorkScheduleDayModelRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class WorkScheduleDayModelApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = WorkScheduleDayModel_1.WorkScheduleDayModel;
        this.deSerializers = deSerializers;
    }
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            SEGMENTS: new odata_v2_1.Link('segments', this, linkedApis[0]),
            SHIFT_CLASSIFICATION_NAV: new odata_v2_1.OneToOneLink('shiftClassificationNav', this, linkedApis[1]),
            VARIANTS: new odata_v2_1.Link('variants', this, linkedApis[2])
        };
        return this;
    }
    requestBuilder() {
        return new WorkScheduleDayModelRequestBuilder_1.WorkScheduleDayModelRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(WorkScheduleDayModel_1.WorkScheduleDayModel, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                NON_WORKING_DAY: fieldBuilder.buildEdmTypeField('nonWorkingDay', 'Edm.Boolean', true),
                /**
                 * Static representation of the {@link roundingBasedOnWorkScheduleInformation} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                ROUNDING_BASED_ON_WORK_SCHEDULE_INFORMATION: fieldBuilder.buildEdmTypeField('roundingBasedOnWorkScheduleInformation', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                VARIANT_USAGE: fieldBuilder.buildEdmTypeField('variantUsage', 'Edm.String', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', WorkScheduleDayModel_1.WorkScheduleDayModel)
            };
        }
        return this._schema;
    }
}
exports.WorkScheduleDayModelApi = WorkScheduleDayModelApi;
//# sourceMappingURL=WorkScheduleDayModelApi.js.map