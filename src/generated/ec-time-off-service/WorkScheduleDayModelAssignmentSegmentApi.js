...
exports.WorkScheduleDayModelAssignmentSegmentApi = void 0;
/*
...
const WorkScheduleDayModelAssignmentSegmentRequestBuilder_1 = require("./WorkScheduleDayModelAssignmentSegmentRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class WorkScheduleDayModelAssignmentSegmentApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = WorkScheduleDayModelAssignmentSegment_1.WorkScheduleDayModelAssignmentSegment;
    ...
    requestBuilder() {
        return new WorkScheduleDayModelAssignmentSegmentRequestBuilder_1.WorkScheduleDayModelAssignmentSegmentRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(WorkScheduleDayModelAssignmentSegment_1.WorkScheduleDayModelAssignmentSegment, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', WorkScheduleDayModelAssignmentSegment_1.WorkScheduleDayModelAssignmentSegment)
            };
        }
        return this._schema;
    }
}
exports.WorkScheduleDayModelAssignmentSegmentApi = WorkScheduleDayModelAssignmentSegmentApi;
//# sourceMappingURL=WorkScheduleDayModelAssignmentSegmentApi.js.map