...
export class TimeTypeAusApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<TimeTypeAus<DeSerializersT>, DeSerializersT>
{
  ...
  requestBuilder(): TimeTypeAusRequestBuilder<DeSerializersT> {
    return new TimeTypeAusRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    TimeTypeAus<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<TimeTypeAus<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<TimeTypeAus<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    TIME_TYPE_EXTERNAL_CODE: OrderableEdmTypeField<
      TimeTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    >;
    ADVANCE_LEAVE_PAYMENT_ALLOWED: OrderableEdmTypeField<
      TimeTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
    ...
    MDF_SYSTEM_RECORD_STATUS: OrderableEdmTypeField<
      ...
      true
    >;
    SPLIT_PAYMENT_ACROSS_FINANCIAL_YEAR_ALLOWED: OrderableEdmTypeField<
      TimeTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ADVANCE_LEAVE_PAYMENT_ALLOWED: fieldBuilder.buildEdmTypeField(
          'advanceLeavePaymentAllowed',
          'Edm.Boolean',
          true
        ),
        /**
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SPLIT_PAYMENT_ACROSS_FINANCIAL_YEAR_ALLOWED:
          fieldBuilder.buildEdmTypeField(
            'splitPaymentAcrossFinancialYearAllowed',
            'Edm.Boolean',
            true
          ),
        ...this.navigationPropertyFields,
