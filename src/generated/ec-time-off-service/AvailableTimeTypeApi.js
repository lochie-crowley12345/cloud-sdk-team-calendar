...
exports.AvailableTimeTypeApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const AvailableTimeType_1 = require("./AvailableTimeType");
const AvailableTimeTypeRequestBuilder_1 = require("./AvailableTimeTypeRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class AvailableTimeTypeApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = AvailableTimeType_1.AvailableTimeType;
        this.deSerializers = deSerializers;
    }
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            TIME_TYPE_NAV: new odata_v2_1.OneToOneLink('timeTypeNav', this, linkedApis[0])
        };
        return this;
    }
    requestBuilder() {
        return new AvailableTimeTypeRequestBuilder_1.AvailableTimeTypeRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(AvailableTimeType_1.AvailableTimeType, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TIME_TYPE_PROFILE_MDF_SYSTEM_EFFECTIVE_START_DATE: fieldBuilder.buildEdmTypeField('TimeTypeProfile_mdfSystemEffectiveStartDate', 'Edm.DateTime', false),
                /**
                 * Static representation of the {@link copyableInTimesheet} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                COPYABLE_IN_TIMESHEET: fieldBuilder.buildEdmTypeField('copyableInTimesheet', 'Edm.Boolean', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TIME_TYPE_FILTER_RULE: fieldBuilder.buildEdmTypeField('timeTypeFilterRule', 'Edm.String', true),
                ...this.navigationPropertyFields,
                /**
                 *
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', AvailableTimeType_1.AvailableTimeType)
            };
        }
        return this._schema;
    }
}
exports.AvailableTimeTypeApi = AvailableTimeTypeApi;
//# sourceMappingURL=AvailableTimeTypeApi.js.map