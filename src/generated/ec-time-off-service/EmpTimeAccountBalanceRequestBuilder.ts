 ...
 */
export class EmpTimeAccountBalanceRequestBuilder<
...
> extends RequestBuilder<EmpTimeAccountBalance<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EmpTimeAccountBalance<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<EmpTimeAccountBalance<T>, T> {
    return new GetAllRequestBuilder<EmpTimeAccountBalance<T>, T>(
      this.entityApi
    );
  }
}
