...
const HolidayRequestBuilder_1 = require("./HolidayRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class HolidayApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Holiday_1.Holiday;
    ...
    requestBuilder() {
        return new HolidayRequestBuilder_1.HolidayRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Holiday_1.Holiday, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Holiday_1.Holiday)
            };
        }
        return this._schema;
    }
...
//# sourceMappingURL=HolidayApi.js.map