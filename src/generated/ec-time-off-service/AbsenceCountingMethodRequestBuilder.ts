 ...
 */
export class AbsenceCountingMethodRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<AbsenceCountingMethod<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<AbsenceCountingMethod<T>, T> {
    return new GetByKeyRequestBuilder<AbsenceCountingMethod<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<AbsenceCountingMethod<T>, T> {
    return new GetAllRequestBuilder<AbsenceCountingMethod<T>, T>(
      this.entityApi
    );
  }
}
