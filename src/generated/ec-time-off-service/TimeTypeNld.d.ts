 ...
 */
export declare class TimeTypeNld<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements TimeTypeNldType<T>
{
  readonly _entityApi: TimeTypeNldApi<T>;
  /**
  ...
  constructor(_entityApi: TimeTypeNldApi<T>);
}
...
//# sourceMappingURL=TimeTypeNld.d.ts.map
