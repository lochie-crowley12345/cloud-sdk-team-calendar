 ...
 */
export declare class TimeManagementTerminationEndHandlingExcludedTimeAccountType<
  ...
  implements TimeManagementTerminationEndHandlingExcludedTimeAccountTypeType<T>
{
  ...
  constructor(
    _entityApi: TimeManagementTerminationEndHandlingExcludedTimeAccountTypeApi<T>
  );
}
...
//# sourceMappingURL=TimeManagementTerminationEndHandlingExcludedTimeAccountType.d.ts.map
