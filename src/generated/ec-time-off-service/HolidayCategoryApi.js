...
exports.HolidayCategoryApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const HolidayCategory_1 = require("./HolidayCategory");
const HolidayCategoryRequestBuilder_1 = require("./HolidayCategoryRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class HolidayCategoryApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = HolidayCategory_1.HolidayCategory;
    ...
    requestBuilder() {
        return new HolidayCategoryRequestBuilder_1.HolidayCategoryRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(HolidayCategory_1.HolidayCategory, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_AR_SA: fieldBuilder.buildEdmTypeField('description_ar_SA', 'Edm.String', true),
                /**
                 * Static representation of the {@link descriptionCyGb} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_CY_GB: fieldBuilder.buildEdmTypeField('description_cy_GB', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_EN_DEBUG: fieldBuilder.buildEdmTypeField('description_en_DEBUG', 'Edm.String', true),
                /**
                 * Static representation of the {@link descriptionEnDebugApos} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_EN_DEBUG_APOS: fieldBuilder.buildEdmTypeField('description_en_DEBUG_APOS', 'Edm.String', true),
                /**
                 * Static representation of the {@link descriptionEnDebugAposRtl} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_EN_DEBUG_APOS_RTL: fieldBuilder.buildEdmTypeField('description_en_DEBUG_APOS_RTL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_EN_RTL: fieldBuilder.buildEdmTypeField('description_en_RTL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_ES_MX: fieldBuilder.buildEdmTypeField('description_es_MX', 'Edm.String', true),
                /**
                 * Static representation of the {@link descriptionFrCa} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_FR_CA: fieldBuilder.buildEdmTypeField('description_fr_CA', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_HI_IN: fieldBuilder.buildEdmTypeField('description_hi_IN', 'Edm.String', true),
                /**
                 * Static representation of the {@link descriptionIwIl} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_IW_IL: fieldBuilder.buildEdmTypeField('description_iw_IL', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DESCRIPTION_TH_TH: fieldBuilder.buildEdmTypeField('description_th_TH', 'Edm.String', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', HolidayCategory_1.HolidayCategory)
            };
        }
        return this._schema;
    }
}
exports.HolidayCategoryApi = HolidayCategoryApi;
//# sourceMappingURL=HolidayCategoryApi.js.map