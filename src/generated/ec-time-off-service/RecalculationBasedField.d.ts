 ...
 */
export declare class RecalculationBasedField<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements RecalculationBasedFieldType<T>
{
  readonly _entityApi: RecalculationBasedFieldApi<T>;
  /**
  ...
  constructor(_entityApi: RecalculationBasedFieldApi<T>);
}
...
//# sourceMappingURL=RecalculationBasedField.d.ts.map
