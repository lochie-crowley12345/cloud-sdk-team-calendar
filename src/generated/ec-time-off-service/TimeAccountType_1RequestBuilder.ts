 ...
 */
export class TimeAccountType_1RequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TimeAccountType_1<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TimeAccountType_1<T>, T> {
    return new GetByKeyRequestBuilder<TimeAccountType_1<T>, T>(this.entityApi, {
