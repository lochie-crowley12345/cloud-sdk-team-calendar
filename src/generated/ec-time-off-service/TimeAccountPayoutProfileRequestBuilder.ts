 ...
 */
export class TimeAccountPayoutProfileRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TimeAccountPayoutProfile<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TimeAccountPayoutProfile<T>, T> {
    return new GetByKeyRequestBuilder<TimeAccountPayoutProfile<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<TimeAccountPayoutProfile<T>, T> {
    return new GetAllRequestBuilder<TimeAccountPayoutProfile<T>, T>(
      this.entityApi
    );
  }
}
