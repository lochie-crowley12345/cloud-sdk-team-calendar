...
export class AbsenceCountingMethodApi<
...
> implements EntityApi<AbsenceCountingMethod<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<AbsenceCountingMethod<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    BASE: OrderableEdmTypeField<
      AbsenceCountingMethod<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CONSIDER_HOLIDAYS: fieldBuilder.buildEdmTypeField(
          'considerHolidays',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        DEDUCTION_FACTOR: fieldBuilder.buildEdmTypeField(
          'deductionFactor',
          'Edm.Decimal',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SATURDAY: fieldBuilder.buildEdmTypeField(
          'saturday',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        THURSDAY: fieldBuilder.buildEdmTypeField(
          'thursday',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WEDNESDAY: fieldBuilder.buildEdmTypeField(
          'wednesday',
          'Edm.Boolean',
          true
        ),
