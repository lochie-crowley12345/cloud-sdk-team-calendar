 ...
 */
export class WorkScheduleDayModelRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<WorkScheduleDayModel<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<WorkScheduleDayModel<T>, T> {
    return new GetByKeyRequestBuilder<WorkScheduleDayModel<T>, T>(
      this.entityApi,
   ...
   */
  create(
    entity: WorkScheduleDayModel<T>
  ): CreateRequestBuilder<WorkScheduleDayModel<T>, T> {
    return new CreateRequestBuilder<WorkScheduleDayModel<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    entity: WorkScheduleDayModel<T>
  ): UpdateRequestBuilder<WorkScheduleDayModel<T>, T> {
    return new UpdateRequestBuilder<WorkScheduleDayModel<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    externalCode: string
  ): DeleteRequestBuilder<WorkScheduleDayModel<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `WorkScheduleDayModel`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<WorkScheduleDayModel<T>, T>(
      this.entityApi,
      externalCodeOrEntity instanceof WorkScheduleDayModel
