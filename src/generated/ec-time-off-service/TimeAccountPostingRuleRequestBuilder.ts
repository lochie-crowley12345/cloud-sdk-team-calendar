 ...
 */
export class TimeAccountPostingRuleRequestBuilder<
...
> extends RequestBuilder<TimeAccountPostingRule<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<TimeAccountPostingRule<T>, T>(
      this.entityApi,
      {
  ...
  getAll(): GetAllRequestBuilder<TimeAccountPostingRule<T>, T> {
    return new GetAllRequestBuilder<TimeAccountPostingRule<T>, T>(
      this.entityApi
    );
  }
}
