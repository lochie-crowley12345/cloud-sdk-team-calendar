...
export class EmployeeTimeEspApi<
...
> implements EntityApi<EmployeeTimeEsp<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimeEsp<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link custEsp} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_ESP: fieldBuilder.buildEdmTypeField(
          'cust_ESP',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ORIGINAL_ABSENCE: fieldBuilder.buildEdmTypeField(
          'originalAbsence',
          'Edm.Boolean',
          true
        ),
