 ...
 */
export class HolidayRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<Holiday<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<Holiday<T>, T> {
    return new GetByKeyRequestBuilder<Holiday<T>, T>(this.entityApi, {
