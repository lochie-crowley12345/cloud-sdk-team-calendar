...
export class EmployeeTimeCalendarApi<
...
> implements EntityApi<EmployeeTimeCalendar<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      TIME_ACCOUNT_DETAIL: new Link('timeAccountDetail', this, linkedApis[0])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimeCalendar<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    EMPLOYEE_TIME_EXTERNAL_CODE: OrderableEdmTypeField<
      EmployeeTimeCalendar<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WORK_SCHEDULE_INTERNAL_ID: fieldBuilder.buildEdmTypeField(
