...
export class WorkScheduleDayApi<
...
> implements EntityApi<WorkScheduleDay<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<WorkScheduleDay<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link custTestdata} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_TESTDATA: fieldBuilder.buildEdmTypeField(
          'cust_testdata',
          'Edm.String',
          true
        ),
