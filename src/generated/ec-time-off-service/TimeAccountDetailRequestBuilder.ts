 ...
 */
export class TimeAccountDetailRequestBuilder<
...
> extends RequestBuilder<TimeAccountDetail<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<TimeAccountDetail<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<TimeAccountDetail<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    timeAccountExternalCodeOrEntity: any,
    externalCode?: string
  ): DeleteRequestBuilder<TimeAccountDetail<T>, T> {
    return new DeleteRequestBuilder<TimeAccountDetail<T>, T>(
      this.entityApi,
      timeAccountExternalCodeOrEntity instanceof TimeAccountDetail
