...
export class TimeAccountTypeAusApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<TimeAccountTypeAus<DeSerializersT>, DeSerializersT>
{
  ...
  requestBuilder(): TimeAccountTypeAusRequestBuilder<DeSerializersT> {
    return new TimeAccountTypeAusRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    TimeAccountTypeAus<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<TimeAccountTypeAus<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    TIME_ACCOUNT_TYPE_EXTERNAL_CODE: OrderableEdmTypeField<
      TimeAccountTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
    ...
    EXTERNAL_CODE: OrderableEdmTypeField<
      ...
      true
    >;
    INCLUDE_IN_LEAVE_LOADING_CALCULATIONS: OrderableEdmTypeField<
      TimeAccountTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
    ...
    MDF_SYSTEM_RECORD_STATUS: OrderableEdmTypeField<
      ...
      true
    >;
    PRIOR_SERVICE_ACCOUNT_DISTINCTION: OrderableEdmTypeField<
      TimeAccountTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
    >;
    PRIOR_SERVICE_USE_CASE: OrderableEdmTypeField<
      TimeAccountTypeAus<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INCLUDE_IN_LEAVE_LOADING_CALCULATIONS: fieldBuilder.buildEdmTypeField(
          'includeInLeaveLoadingCalculations',
          'Edm.Boolean',
          true
        ),
        /**
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRIOR_SERVICE_ACCOUNT_DISTINCTION: fieldBuilder.buildEdmTypeField(
          'priorServiceAccountDistinction',
          'Edm.String',
          true
        ),
        /**
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRIOR_SERVICE_USE_CASE: fieldBuilder.buildEdmTypeField(
          'priorServiceUseCase',
          'Edm.String',
          true
        ),
