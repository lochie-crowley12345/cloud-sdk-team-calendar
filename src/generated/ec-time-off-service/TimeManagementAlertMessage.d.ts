 ...
 */
export declare class TimeManagementAlertMessage<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TimeManagementAlertMessageType<T>
{
  readonly _entityApi: TimeManagementAlertMessageApi<T>;
  /**
  ...
  constructor(_entityApi: TimeManagementAlertMessageApi<T>);
}
