 ...
 */
export class WorkScheduleDayModelSegmentRequestBuilder<
...
> extends RequestBuilder<WorkScheduleDayModelSegment<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<WorkScheduleDayModelSegment<T>, T>(
      this.entityApi,
      {
  ...
  getAll(): GetAllRequestBuilder<WorkScheduleDayModelSegment<T>, T> {
    return new GetAllRequestBuilder<WorkScheduleDayModelSegment<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<WorkScheduleDayModelSegment<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<WorkScheduleDayModelSegment<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    workScheduleDayModelExternalCodeOrEntity: any,
    externalCode?: string
  ): DeleteRequestBuilder<WorkScheduleDayModelSegment<T>, T> {
    return new DeleteRequestBuilder<WorkScheduleDayModelSegment<T>, T>(
      this.entityApi,
      workScheduleDayModelExternalCodeOrEntity instanceof
