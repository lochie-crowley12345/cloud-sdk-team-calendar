 ...
 */
export declare class EmployeeTimeNld<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements EmployeeTimeNldType<T>
{
  readonly _entityApi: EmployeeTimeNldApi<T>;
  /**
  ...
  workCapacityPercentageDuringIllness?: DeserializedType<
    ...
    'Edm.Decimal'
  > | null;
  constructor(_entityApi: EmployeeTimeNldApi<T>);
}
...
//# sourceMappingURL=EmployeeTimeNld.d.ts.map
