 ...
 */
export class TimeAccountTypeAusRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<TimeAccountTypeAus<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<TimeAccountTypeAus<T>, T> {
    return new GetByKeyRequestBuilder<TimeAccountTypeAus<T>, T>(
      this.entityApi,
      {
