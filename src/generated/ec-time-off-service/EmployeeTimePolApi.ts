...
export class EmployeeTimePolApi<
...
> implements EntityApi<EmployeeTimePol<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<EmployeeTimePol<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_POL: fieldBuilder.buildEdmTypeField(
          'cust_pol',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ZLA_DELIVERY_DATE: fieldBuilder.buildEdmTypeField(
          'zlaDeliveryDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ZLA_DOCUMENT_NUMBER: fieldBuilder.buildEdmTypeField(
          'zlaDocumentNumber',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ZLA_ISSUE_DATE: fieldBuilder.buildEdmTypeField(
          'zlaIssueDate',
          'Edm.DateTime',
          true
        ),
