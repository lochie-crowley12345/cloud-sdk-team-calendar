...
> implements EntityApi<TimeAccount<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      TIME_ACCOUNT_DETAILS: new Link('timeAccountDetails', this, linkedApis[1])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TimeAccount<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_CLOSED: fieldBuilder.buildEdmTypeField(
          'accountClosed',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_END_DATE: fieldBuilder.buildEdmTypeField(
          'bookingEndDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BOOKING_START_DATE: fieldBuilder.buildEdmTypeField(
          'bookingStartDate',
          'Edm.DateTime',
          true
        ),
        ...
        /**
         * Static representation of the {@link custCustDenmarkValue} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_CUST_DENMARK_VALUE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_TEST: fieldBuilder.buildEdmTypeField(
          'cust_test',
          'Edm.Decimal',
          true
        ),
