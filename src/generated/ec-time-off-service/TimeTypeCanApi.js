...
exports.TimeTypeCanApi = void 0;
/*
 * Copyright (c) 2025 SAP SE or an SAP affiliate company. All rights reserved.
 *
 * This is a generated file powered by the SAP Cloud SDK for JavaScript.
 */
const TimeTypeCan_1 = require("./TimeTypeCan");
const TimeTypeCanRequestBuilder_1 = require("./TimeTypeCanRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class TimeTypeCanApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = TimeTypeCan_1.TimeTypeCan;
    ...
    requestBuilder() {
        return new TimeTypeCanRequestBuilder_1.TimeTypeCanRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(TimeTypeCan_1.TimeTypeCan, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', TimeTypeCan_1.TimeTypeCan)
            };
        }
        return this._schema;
    }
}
exports.TimeTypeCanApi = TimeTypeCanApi;
//# sourceMappingURL=TimeTypeCanApi.js.map