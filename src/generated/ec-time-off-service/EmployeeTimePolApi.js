...
exports.EmployeeTimePolApi = void 0;
/*
...
const EmployeeTimePolRequestBuilder_1 = require("./EmployeeTimePolRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class EmployeeTimePolApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = EmployeeTimePol_1.EmployeeTimePol;
    ...
    requestBuilder() {
        return new EmployeeTimePolRequestBuilder_1.EmployeeTimePolRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(EmployeeTimePol_1.EmployeeTimePol, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                ...
                /**
                 * Static representation of the {@link custPol} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUST_POL: fieldBuilder.buildEdmTypeField('cust_pol', 'Edm.String', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', EmployeeTimePol_1.EmployeeTimePol)
            };
        }
        return this._schema;
    }
}
exports.EmployeeTimePolApi = EmployeeTimePolApi;
//# sourceMappingURL=EmployeeTimePolApi.js.map