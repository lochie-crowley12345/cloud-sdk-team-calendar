...
export class HolidayAssignmentApi<
...
> implements EntityApi<HolidayAssignment<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      HOLIDAY_CATEGORY_NAV: new OneToOneLink(
        'holidayCategoryNav',
        this,
        linkedApis[0]
      ),
      HOLIDAY_NAV: new OneToOneLink('holidayNav', this, linkedApis[1])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<HolidayAssignment<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    HOLIDAY_CALENDAR_EXTERNAL_CODE: OrderableEdmTypeField<
      HolidayAssignment<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        HOLIDAY_CALENDAR_EXTERNAL_CODE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUST_TEST_HOLIDAY_ASSIGNMENT: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        HOLIDAY_CATEGORY: fieldBuilder.buildEdmTypeField(
          'holidayCategory',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        HOLIDAY_CLASS: fieldBuilder.buildEdmTypeField(
          'holidayClass',
          'Edm.String',
          true
        ),
