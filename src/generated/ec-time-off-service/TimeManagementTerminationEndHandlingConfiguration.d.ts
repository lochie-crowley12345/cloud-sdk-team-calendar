 ...
 */
export declare class TimeManagementTerminationEndHandlingConfiguration<
  ...
  implements TimeManagementTerminationEndHandlingConfigurationType<T>
{
  ...
  constructor(
    _entityApi: TimeManagementTerminationEndHandlingConfigurationApi<T>
  );
}
...
//# sourceMappingURL=TimeManagementTerminationEndHandlingConfiguration.d.ts.map
