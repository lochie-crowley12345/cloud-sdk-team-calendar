...
export class AvailableTimeTypeApi<
...
> implements EntityApi<AvailableTimeType<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(linkedApis: [TimeTypeApi<DeSerializersT>]): this {
    this.navigationPropertyFields = {
      TIME_TYPE_NAV: new OneToOneLink('timeTypeNav', this, linkedApis[0])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<AvailableTimeType<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    TIME_TYPE_PROFILE_EXTERNAL_CODE: OrderableEdmTypeField<
      AvailableTimeType<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_TYPE_PROFILE_EXTERNAL_CODE: fieldBuilder.buildEdmTypeField(
          'TimeTypeProfile_externalCode',
          'Edm.String',
          false
        ),
        /**
         * Static representation of the {@link timeTypeProfileMdfSystemEffectiveStartDate} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_TYPE_PROFILE_MDF_SYSTEM_EFFECTIVE_START_DATE:
        ...
        /**
         * Static representation of the {@link copyableInTimesheet} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        COPYABLE_IN_TIMESHEET: fieldBuilder.buildEdmTypeField(
          'copyableInTimesheet',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ENABLED_IN_ESS_SCENARIO: fieldBuilder.buildEdmTypeField(
          'enabledInEssScenario',
          'Edm.Boolean',
          true
        ),
        /**
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        FAVORITE_TIME_TYPE: fieldBuilder.buildEdmTypeField(
          'favoriteTimeType',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        HIDE_ACCOUNT_BALANCE: fieldBuilder.buildEdmTypeField(
          'hideAccountBalance',
          'Edm.Boolean',
          true
        ),
        ...
        /**
         * Static representation of the {@link timeTypeFilterRule} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TIME_TYPE_FILTER_RULE: fieldBuilder.buildEdmTypeField(
          'timeTypeFilterRule',
          'Edm.String',
          true
        ),
