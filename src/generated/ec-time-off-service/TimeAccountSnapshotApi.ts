...
export class TimeAccountSnapshotApi<
...
> implements EntityApi<TimeAccountSnapshot<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ACCOUNT_TYPE_NAV: new OneToOneLink('accountTypeNav', this, linkedApis[0])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TimeAccountSnapshot<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    ACCOUNT_TYPE: OrderableEdmTypeField<
      TimeAccountSnapshot<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ACCOUNT_TYPE: fieldBuilder.buildEdmTypeField(
          'accountType',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        APPROVED_ABSENCE_BALANCE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        APPROVED_ABSENCE_BALANCE_ACCRUAL_SEPARATED:
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AS_OF_ACCOUNTING_PERIOD_END: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AS_OF_PAY_PERIOD_END: fieldBuilder.buildEdmTypeField(
          'asOfPayPeriodEnd',
          'Edm.Boolean',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BALANCE_ACCRUAL_SEPARATED: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BALANCE_EFFECTIVE_DATE: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        OUTDATED: fieldBuilder.buildEdmTypeField(
          'outdated',
          'Edm.Boolean',
          true
        ),
