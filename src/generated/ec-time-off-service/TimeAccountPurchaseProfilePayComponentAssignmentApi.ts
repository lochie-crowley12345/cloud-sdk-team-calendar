...
export class TimeAccountPurchaseProfilePayComponentAssignmentApi<
    ...
    >
{
  ...
  requestBuilder(): TimeAccountPurchaseProfilePayComponentAssignmentRequestBuilder<DeSerializersT> {
    return new TimeAccountPurchaseProfilePayComponentAssignmentRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof TimeAccountPurchaseProfilePayComponentAssignment,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    TIME_ACCOUNT_PURCHASE_PROFILE_EXTERNAL_CODE: OrderableEdmTypeField<
      TimeAccountPurchaseProfilePayComponentAssignment<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         */
        TIME_ACCOUNT_PURCHASE_PROFILE_EXTERNAL_CODE:
