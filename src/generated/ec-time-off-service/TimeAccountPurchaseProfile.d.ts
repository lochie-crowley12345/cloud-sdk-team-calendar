 ...
 */
export declare class TimeAccountPurchaseProfile<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TimeAccountPurchaseProfileType<T>
{
  readonly _entityApi: TimeAccountPurchaseProfileApi<T>;
  /**
  ...
  constructor(_entityApi: TimeAccountPurchaseProfileApi<T>);
}
