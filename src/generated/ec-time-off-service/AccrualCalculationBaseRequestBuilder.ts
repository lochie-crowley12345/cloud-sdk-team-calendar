 ...
 */
export class AccrualCalculationBaseRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<AccrualCalculationBase<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<AccrualCalculationBase<T>, T> {
    return new GetByKeyRequestBuilder<AccrualCalculationBase<T>, T>(
      this.entityApi,
  ...
  getAll(): GetAllRequestBuilder<AccrualCalculationBase<T>, T> {
    return new GetAllRequestBuilder<AccrualCalculationBase<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: AccrualCalculationBase<T>
  ): CreateRequestBuilder<AccrualCalculationBase<T>, T> {
    return new CreateRequestBuilder<AccrualCalculationBase<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    entity: AccrualCalculationBase<T>
  ): UpdateRequestBuilder<AccrualCalculationBase<T>, T> {
    return new UpdateRequestBuilder<AccrualCalculationBase<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    externalCode: string
  ): DeleteRequestBuilder<AccrualCalculationBase<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `AccrualCalculationBase`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<AccrualCalculationBase<T>, T>(
      this.entityApi,
      externalCodeOrEntity instanceof AccrualCalculationBase
