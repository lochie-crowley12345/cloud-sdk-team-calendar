 ...
 */
export declare class ElectronicSicknessCertificateExclusionReasonDeu<
  ...
  implements ElectronicSicknessCertificateExclusionReasonDeuType<T>
{
  ...
  constructor(
    _entityApi: ElectronicSicknessCertificateExclusionReasonDeuApi<T>
  );
}
...
//# sourceMappingURL=ElectronicSicknessCertificateExclusionReasonDeu.d.ts.map
