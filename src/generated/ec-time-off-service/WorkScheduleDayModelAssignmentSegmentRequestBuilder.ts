 ...
 */
export class WorkScheduleDayModelAssignmentSegmentRequestBuilder<
...
> extends RequestBuilder<WorkScheduleDayModelAssignmentSegment<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<
      WorkScheduleDayModelAssignmentSegment<T>,
      T
    >(this.entityApi, {
  ...
  delete(
    workScheduleDayModelAssignmentDayOrEntity: any,
    workScheduleExternalCode?: string,
    externalCode?: string
  ): DeleteRequestBuilder<WorkScheduleDayModelAssignmentSegment<T>, T> {
    ...
    >(
      this.entityApi,
      workScheduleDayModelAssignmentDayOrEntity instanceof
