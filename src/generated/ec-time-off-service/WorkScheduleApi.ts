...
> implements EntityApi<WorkSchedule<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      PERIOD_MODEL_NAV: new OneToOneLink('periodModelNav', this, linkedApis[0]),
      ...
      WORK_SCHEDULE_DAYS: new Link('workScheduleDays', this, linkedApis[3])
    };
    return this;
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<WorkSchedule<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVERAGE_HOURS_PER_DAY: fieldBuilder.buildEdmTypeField(
          'averageHoursPerDay',
          'Edm.Decimal',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVERAGE_HOURS_PER_MONTH: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVERAGE_HOURS_PER_WEEK: fieldBuilder.buildEdmTypeField(
          'averageHoursPerWeek',
          'Edm.Decimal',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVERAGE_HOURS_PER_YEAR: fieldBuilder.buildEdmTypeField(
          'averageHoursPerYear',
          'Edm.Decimal',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        AVERAGE_WORKING_DAYS_PER_WEEK: fieldBuilder.buildEdmTypeField(
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        INDIVIDUAL_WORK_SCHEDULE: fieldBuilder.buildEdmTypeField(
          'individualWorkSchedule',
          'Edm.Boolean',
          true
        ),
        /**
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        MODEL_CATEGORY: fieldBuilder.buildEdmTypeField(
          'modelCategory',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PERIOD_MODEL: fieldBuilder.buildEdmTypeField(
          'periodModel',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SEARCH_STRING: fieldBuilder.buildEdmTypeField(
          'searchString',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        SIMULATED_WORK_SCHEDULE: fieldBuilder.buildEdmTypeField(
