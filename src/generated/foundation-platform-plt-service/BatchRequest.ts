...
/**
 * Batch builder for operations supported on the Foundation Platform Plt Service.
 * @param requests The requests of the batch
 * @returns A request builder for batch.
 */
export function batch<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    | ReadFoundationPlatformPltServiceRequestBuilder<DeSerializersT>
...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultFoundationPlatformPltServicePath,
    transformVariadicArgumentToArray(first, rest)
  );
}

/**
 * Change set constructor consists of write operations supported on the Foundation Platform Plt Service.
 * @param requests The requests of the change set
 * @returns A change set for batch.
 */
export function changeset<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    WriteFoundationPlatformPltServiceRequestBuilder<DeSerializersT>
  >
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  requests: Array<
...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteFoundationPlatformPltServiceRequestBuilder<DeSerializersT>
    | Array<WriteFoundationPlatformPltServiceRequestBuilder<DeSerializersT>>,
  ...rest: Array<
    WriteFoundationPlatformPltServiceRequestBuilder<DeSerializersT>
  >
): BatchChangeSet<DeSerializersT> {
...
export const defaultFoundationPlatformPltServicePath = '/odata/v2';
export type ReadFoundationPlatformPltServiceRequestBuilder<
...
> =
  ...
  | FunctionImportRequestBuilder<
      ...
      SefExtEventMetaDataList
    >;
export type WriteFoundationPlatformPltServiceRequestBuilder<
  DeSerializersT extends DeSerializers
> =
