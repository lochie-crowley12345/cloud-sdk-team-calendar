...
const CountryRequestBuilder_1 = require("./CountryRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class CountryApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Country_1.Country;
    ...
    requestBuilder() {
        return new CountryRequestBuilder_1.CountryRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Country_1.Country, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                IS_DRM_ENABLED: fieldBuilder.buildEdmTypeField('isDRMEnabled', 'Edm.Boolean', true),
                /**
                 * Static representation of the {@link isSetByMigrate} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                IS_SET_BY_MIGRATE: fieldBuilder.buildEdmTypeField('isSetByMigrate', 'Edm.Boolean', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                NUMERIC_COUNTRY_CODE: fieldBuilder.buildEdmTypeField('numericCountryCode', 'Edm.Int64', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TERRITORY_ID: fieldBuilder.buildEdmTypeField('territoryId', 'Edm.Int64', true),
                /**
                 * Static representation of the {@link twoCharCountryCode} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TWO_CHAR_COUNTRY_CODE: fieldBuilder.buildEdmTypeField('twoCharCountryCode', 'Edm.String', true),
                ...this.navigationPropertyFields,
                /**
                 *
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Country_1.Country)
            };
        }
        return this._schema;
    }
