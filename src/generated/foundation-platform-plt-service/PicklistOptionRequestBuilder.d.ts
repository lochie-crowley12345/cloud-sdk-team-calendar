 ...
 */
export declare class PicklistOptionRequestBuilder<
...
> extends RequestBuilder<PicklistOption<T>, T> {
   ...
   */
  create(entity: PicklistOption<T>): CreateRequestBuilder<PicklistOption<T>, T>;
  /**
   ...
   */
  update(entity: PicklistOption<T>): UpdateRequestBuilder<PicklistOption<T>, T>;
}
