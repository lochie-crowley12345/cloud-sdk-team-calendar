...
const CurrencyRequestBuilder_1 = require("./CurrencyRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class CurrencyApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Currency_1.Currency;
    ...
    requestBuilder() {
        return new CurrencyRequestBuilder_1.CurrencyRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Currency_1.Currency, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                DEFAULT_DECIMALS: fieldBuilder.buildEdmTypeField('defaultDecimals', 'Edm.Int64', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Currency_1.Currency)
            };
        }
        return this._schema;
    }
