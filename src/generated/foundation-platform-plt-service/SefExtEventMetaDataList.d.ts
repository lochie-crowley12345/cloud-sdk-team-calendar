 ...
 */
import { SefExtEventMetaDataField } from './SefExtEventMetaData';
import {
  ComplexTypeField,
  ConstructorOrField,
  DeSerializers,
 ...
 */
export declare class SefExtEventMetaDataListField<
...
export declare namespace SefExtEventMetaDataList {
   ...
   */
  const _propertyMetadata: PropertyMetadata<SefExtEventMetaDataList>[];
}
