 ...
 */
export declare class ExternalLearnerPersonalInfo<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExternalLearnerPersonalInfoType<T>
{
  readonly _entityApi: ExternalLearnerPersonalInfoApi<T>;
  /**
  ...
  constructor(_entityApi: ExternalLearnerPersonalInfoApi<T>);
}
