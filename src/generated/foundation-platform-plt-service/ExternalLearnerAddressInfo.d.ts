 ...
 */
export declare class ExternalLearnerAddressInfo<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExternalLearnerAddressInfoType<T>
{
  readonly _entityApi: ExternalLearnerAddressInfoApi<T>;
  /**
  ...
  constructor(_entityApi: ExternalLearnerAddressInfoApi<T>);
}
