 ...
 */
export declare class TeamGoalOwner<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements TeamGoalOwnerType<T>
{
  readonly _entityApi: TeamGoalOwnerApi<T>;
  /**
  ...
  constructor(_entityApi: TeamGoalOwnerApi<T>);
}
...
//# sourceMappingURL=TeamGoalOwner.d.ts.map
