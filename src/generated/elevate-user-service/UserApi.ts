...
> implements EntityApi<User<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    ...
    ADDRESS_LINE_3: OrderableEdmTypeField<
      ...
      true
    >;
    ASSIGNMENT_UUID: OrderableEdmTypeField<
      User<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
    ...
    CITY: OrderableEdmTypeField<
      ...
      true
    >;
    COMPANY_EXIT_DATE: OrderableEdmTypeField<
      User<DeSerializers>,
      DeSerializersT,
      'Edm.DateTime',
      true,
    ...
    IMPACT_OF_LOSS_COMMENTS: OrderableEdmTypeField<
      ...
      true
    >;
    IS_PRIMARY_ASSIGNMENT: OrderableEdmTypeField<
      User<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      false,
    ...
    PROMOTION_AMOUNT: OrderableEdmTypeField<
      ...
      true
    >;
    PRONOUNS: OrderableEdmTypeField<
      User<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
    ...
    SYS_STARTING_SALARY: OrderableEdmTypeField<
      ...
      true
    >;
    TEAM_MEMBERS_SIZE: OrderableEdmTypeField<
      User<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        ASSIGNMENT_UUID: fieldBuilder.buildEdmTypeField(
          'assignmentUUID',
          'Edm.String',
          false
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        COMPANY_EXIT_DATE: fieldBuilder.buildEdmTypeField(
          'companyExitDate',
          'Edm.DateTime',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        IS_PRIMARY_ASSIGNMENT: fieldBuilder.buildEdmTypeField(
          'isPrimaryAssignment',
          'Edm.Boolean',
          false
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        PRONOUNS: fieldBuilder.buildEdmTypeField(
          'pronouns',
          'Edm.String',
          true
        ),
         ...
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        TEAM_MEMBERS_SIZE: fieldBuilder.buildEdmTypeField(
          'teamMembersSize',
          'Edm.Int32',
          true
        ),
