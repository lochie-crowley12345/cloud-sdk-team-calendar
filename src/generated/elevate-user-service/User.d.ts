...
/**
 * This class represents the entity "User" of service "UserNav".
 */
export declare class User<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements UserType<T>
{
  readonly _entityApi: UserApi<T>;
  /**
   ...
   * Maximum length: 32.
   */
  assignmentUuid: DeserializedType<T, 'Edm.String'>;
  /**
   * Bench Strength.
   * @nullable
   */
   ...
   * @nullable
   */
  companyExitDate?: DeserializedType<T, 'Edm.DateTime'> | null;
  /**
   ...
   * isPrimaryAssignment.
   */
  isPrimaryAssignment: DeserializedType<T, 'Edm.Boolean'>;
  /**
   * Issue Comments.
   * @nullable
   */
   ...
   * @nullable
   */
  pronouns?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Raise Prorating.
   * @nullable
   */
   ...
   * @nullable
   */
  teamMembersSize?: DeserializedType<T, 'Edm.Int32'> | null;
  /**
   * Time Zone.
   * Maximum length: 16.
   * @nullable
  ...
  constructor(_entityApi: UserApi<T>);
}
